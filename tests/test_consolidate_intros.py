...
class TestConsolidateIntros(unittest.TestCase):
    ...
    def test_making_up_missing_intro_end_pick_closest(self):
        result = self.do_test(
            intros=[minutes_to_seconds(30),minutes_to_seconds(60), minutes_to_seconds(90)],
            backup_intro_ts=[minutes_to_seconds(119),minutes_to_seconds(120)],
            news_reports=[minutes_to_seconds(40), minutes_to_seconds(70), minutes_to_seconds(100)])
        np.testing.assert_array_equal(result,
                                      [minutes_to_seconds(30), minutes_to_seconds(60), minutes_to_seconds(90),minutes_to_seconds(119)])
